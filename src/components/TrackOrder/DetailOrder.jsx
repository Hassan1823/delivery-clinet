    ...
    const fetchOrder = async () => {
      ...
      if (!response.ok) {
        ...
        if (order?.data?.status === "pending") {
          setIndex(1);
        } else if (order?.data?.status === "prepare") {
          setIndex(1);
        } else if (order?.data?.status === "system") {
          setIndex(1);
        } else if (order?.data?.status === "Ready") {
          setIndex(2);
        } else if (order?.data?.status === "delivery") {
          setIndex(4);
        } else if (order?.data?.status === "return") {
          setIndex(3);
        } else if (order?.data?.status === "cancel") {
          setIndex(3);
        } else {
          setIndex(1);
        }
